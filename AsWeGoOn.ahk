...
CoordMode, Screen
y::MouseMove, 0, -A_ScreenHeight*1/2 ,0, R
m::MouseMove, 0, A_ScreenHeight*1/2 ,0, R
SC027::MouseMove, A_ScreenWidth*1/2, 0 ,0, R
h::MouseMove, -A_ScreenWidth*1/2, 0 ,0, R
...
;---------------------------------------------------------------------------------------------------------
    ...
    Capslock & ,::SendInput {Blind}{ctrl down}{Del Down}{ctrl up}
