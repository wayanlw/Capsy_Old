...
F11::
    ...
    { 
        ...
        { 
            ...
            If GetKeyState("0", "P") ;DOWN
                yVal := IncrementValue 
            Else If GetKeyState("F11", "P") ; UP
                yVal := -IncrementValue 
            If !yVal 
                yVal := 0 
            If GetKeyState("9", "P") ;LEFT
                xVal := -IncrementValue 
            Else If GetKeyState("-", "P") ;RIGHT
                xVal := IncrementValue 
            If !xVal 
                xVal := 0 
...
return 
;Mouse buttons and Mouse Clicks
Capslock & =::SendInput {LButton}
Capslock & 8::SendInput {RButton}
capslock & F10:: Send {WheelUp}
capslock & F12:: Send {WheelDown}
...
/*
capslock & F8:: Send {WheelUp}
capslock & F10:: Send {WheelDown}
